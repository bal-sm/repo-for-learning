...
"""taken from https://doc.qt.io/qtforpython/examples/example_multimedia__player.html"""
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # about_qt_act = QAction("About &Qt", self, triggered=qApp.aboutQt) fixed code below
    ...
    def update_buttons(self, state):
        ...
        self._play_action.setEnabled(
            media_count > 0 and state != QMediaPlayer.PlayingState
        )
