# from `components/inline_validation/forms.py`
...
# * my opinion: pusing, aku karena baca "Views - The Right Way" tea, sometimes ribet OOP,
# * tapi dipake-nya untuk satu hal, itu adalah ide buruk.
# *
# * terus lagipula, is it really necessary kalau beres typing ke input, langsung jreng,
# * ada error-nya segala.. hm maybe it is. mending pake Alpine.js, bener gak? yes.
