# from `components/inline_validation/input.py`
...
# * my opinion: in the end harus dijabarin gitu ya, value-value-s-nya, cuman anggeur,
# * mending serahin aja ke JS, how, IDK, yet
