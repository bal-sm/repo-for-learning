...
- If [`get_internal_type()`](https://docs.djangoproject.com/en/5.0/ref/models/fields/#django.db.models.Field.get_internal_type) 
  - returns a string that is not known to Django for the database backend you are using – 
  - that is, it doesn’t appear in `django.db.backends.<db_name>.base.DatabaseWrapper.data_types` – 
  - the string will still be used by the serializer,
    - but the default [`db_type()`](https://docs.djangoproject.com/en/5.0/ref/models/fields/#django.db.models.Field.db_type) method will return `None`. 
